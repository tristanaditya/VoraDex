				...
				context:Register("SAVE_SCRIPT",{Name = "Save Script", IconMap = Explorer.MiscIcons, Icon = "Save", OnClick = function()
					for _, v in next, selection.List do
						if v.Obj:IsA("LuaSourceContainer") and env.isViableDecompileScript(v.Obj) then
							...
							if not success or not source then source = ("-- VORADEX - %s failed to decompile %s"):format(env.executor, v.Obj.ClassName) end
	...
	A script viewer that is basically a notepad
		...
		local function main()
			...
			ScriptViewer.ViewScript = function(scr)
				...
				if not success or not source then source, PreviousScr = ("-- VORADEX - %s failed to decompile %s"):format(env.executor, scr.ClassName), nil else PreviousScr = scr end
...
Main = (function()
	...
	Main.Error = function(str)
		if rconsoleprint then
			rconsoleprint("VORADEX ERROR:"..tostring(str).."\n")
			wait(9e9)
		else
			error(str)
		end
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="VoraDex",TextColor3=Color3.new(1,1,1),TextSize=30,TextTransparency=1,}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by nat.sh",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.MainFrame:TweenSize(val and UDim2.new(0,54,0,54) or UDim2.new(0,0,0,0),Enum.EasingDirection.Out,Enum.EasingStyle.Quad,0.2,true)
	...
	Main.CreateMainGui = function()
		...
		-- Create Main Apps
		Main.CreateApp({Name = "VoraExplorer", IconMap = Main.LargeIcons, Icon = "Explorer", Open = true, Window = Explorer.Window})
